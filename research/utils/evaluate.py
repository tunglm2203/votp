...
# Env info keys that we don't want cluttering the eval logs (mostly MetaWorld shaping terms).
EXCLUDED_METRICS = {"obj_to_target", "near_object", "in_place_reward", "grasp_success", "grasp_reward", "discount"}
